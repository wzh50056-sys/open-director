import type { ChatCompletionMessage } from "@/features/infinite-canvas/services/api/image";
import { imageReferenceLabel } from "@/features/infinite-canvas/lib/image-reference-prompt";
import { seedanceReferenceLabel } from "@/features/infinite-canvas/lib/seedance-video";
...
import type { VideoElementItem, VideoElementReference, VideoMultiPromptItem } from "@/features/infinite-canvas/stores/use-config-store";
...
export async function hydrateNodeGenerationContext(context: NodeGenerationContext) {
    const { imageToDataUrl } = await import("@/features/infinite-canvas/services/image-storage");
    return {
        ...context,
