...
import { AssetFormModal } from "@/features/infinite-canvas/components/assets/asset-form-modal";
import { PromptDetailDialog } from "@/features/infinite-canvas/components/prompts/prompt-detail-dialog";
import { useCopyText } from "@/features/infinite-canvas/hooks/use-copy-text";
...
import { fetchAssetLibrary, type AssetLibraryItem } from "@/features/infinite-canvas/services/api/assets";
import { fetchPrompts, type Prompt } from "@/features/infinite-canvas/services/api/prompts";
import { useAssetStore, type Asset } from "@/features/infinite-canvas/stores/use-asset-store";
