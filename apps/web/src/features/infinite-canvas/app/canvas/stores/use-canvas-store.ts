...
import { listCanvasProjects, saveCanvasProject, syncCanvasProjects } from "@/features/infinite-canvas/services/api/canvas-tasks";
import { fetchUserConfig } from "@/features/infinite-canvas/services/api/user-config";
import { useUserStore } from "@/features/infinite-canvas/stores/use-user-store";
import type { CanvasBackgroundMode } from "@/features/infinite-canvas/lib/canvas-theme";
