import { apiDelete, apiGet, apiPost, compactApiParams } from "@/features/infinite-canvas/services/api/request";
import type { Prompt, PromptListResponse } from "@/features/infinite-canvas/services/api/prompts";
