import type { CanvasProject } from "@/features/infinite-canvas/app/canvas/stores/use-canvas-store";
import { apiGet, apiPost } from "@/features/infinite-canvas/services/api/request";
